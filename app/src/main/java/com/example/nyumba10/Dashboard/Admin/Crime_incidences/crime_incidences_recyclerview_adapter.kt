...
class crime_incidences_recyclerview_adapter(var context: Context,var crimeIncidencesarraylist: ArrayList<crime_incidences_data_class>) : RecyclerView.Adapter<crime_incidences_recyclerview_adapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): crime_incidences_recyclerview_adapter.ViewHolder {

        var view=LayoutInflater.from(parent.context).inflate(R.layout.crime_incidences_recycler_layout,parent,false)
