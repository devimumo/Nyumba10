package com.example.nyumba10.Dashboard.GroupChat.adapter
...
import com.example.nyumba10.Dashboard.MyAssociation.Association_search.associations_data_class
...
class association_group_chat_adapter  (var chats: ArrayList<association_chat_messages_dataclass>, val c: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>()  {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType==1)
        {
            val view= LayoutInflater.from(parent.context).inflate(R.layout.layout,parent,false)

            return association_group_chat_adapter.ViewHolder_one(view)
        ...
        else
        {
            ...
            return association_group_chat_adapter.Guest_viewholder(view)
